...
class CourseProgrammingOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        return [
            ...
            Stat::make('CURSOS ANULADOS', Programming::query()->where('canceled', 1)->count())->description('Total cursos anulados')->descriptionIcon('heroicon-s-no-symbol')->color('danger'),
        ];
    }
}